...
func (SystemEvent_Severity) EnumDescriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{54, 0}
}
...
func (SystemEvent_Category) EnumDescriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{54, 1}
}
...
type LoginRequest struct {
	...
	DisableVNCAuth                *bool   `protobuf:"varint,42,opt,name=disableVNCAuth,proto3,oneof" json:"disableVNCAuth,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *LoginRequest) GetDisableVNCAuth() bool {
	if x != nil && x.DisableVNCAuth != nil {
...
type GetConfigResponse struct {
	...
	DisableVNCAuth                bool   `protobuf:"varint,29,opt,name=disableVNCAuth,proto3" json:"disableVNCAuth,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *GetConfigResponse) GetDisableVNCAuth() bool {
	if x != nil {
		return x.DisableVNCAuth
	}
	return false
...
type SetConfigRequest struct {
	...
	DisableVNCAuth                *bool                `protobuf:"varint,37,opt,name=disableVNCAuth,proto3,oneof" json:"disableVNCAuth,omitempty"`
	unknownFields                 protoimpl.UnknownFields
	sizeCache                     protoimpl.SizeCache
}
...
func (x *SetConfigRequest) GetDisableVNCAuth() bool {
	if x != nil && x.DisableVNCAuth != nil {
		return *x.DisableVNCAuth
	}
	return false
...
func (*PortInfo_Range) Descriptor() ([]byte, []int) {
	return file_daemon_proto_rawDescGZIP(), []int{31, 0}
}
...
var file_daemon_proto_goTypes = []any{
	...
	(*VNCServerState)(nil),                     // 28: daemon.VNCServerState
	...
	nil,                                        // 96: daemon.Network.ResolvedIPsEntry
	(*PortInfo_Range)(nil),                     // 97: daemon.PortInfo.Range
	nil,                                        // 98: daemon.SystemEvent.MetadataEntry
...
var file_daemon_proto_depIdxs = []int32{
	...
	99,  // 1: daemon.LoginRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	29,  // 2: daemon.StatusResponse.fullStatus:type_name -> daemon.FullStatus
	100, // 3: daemon.PeerState.connStatusUpdate:type_name -> google.protobuf.Timestamp
	100, // 4: daemon.PeerState.lastWireguardHandshake:type_name -> google.protobuf.Timestamp
	99,  // 5: daemon.PeerState.latency:type_name -> google.protobuf.Duration
	...
	28,  // 15: daemon.FullStatus.vncServerState:type_name -> daemon.VNCServerState
	35,  // 16: daemon.ListNetworksResponse.routes:type_name -> daemon.Network
	96,  // 17: daemon.Network.resolvedIPs:type_name -> daemon.Network.ResolvedIPsEntry
	97,  // 18: daemon.PortInfo.range:type_name -> daemon.PortInfo.Range
	36,  // 19: daemon.ForwardingRule.destinationPort:type_name -> daemon.PortInfo
	36,  // 20: daemon.ForwardingRule.translatedPort:type_name -> daemon.PortInfo
	37,  // 21: daemon.ForwardingRulesResponse.rules:type_name -> daemon.ForwardingRule
	...
	45,  // 24: daemon.ListStatesResponse.states:type_name -> daemon.State
	54,  // 25: daemon.TracePacketRequest.tcp_flags:type_name -> daemon.TCPFlags
	56,  // 26: daemon.TracePacketResponse.stages:type_name -> daemon.TraceStage
	3,   // 27: daemon.SystemEvent.severity:type_name -> daemon.SystemEvent.Severity
	4,   // 28: daemon.SystemEvent.category:type_name -> daemon.SystemEvent.Category
	100, // 29: daemon.SystemEvent.timestamp:type_name -> google.protobuf.Timestamp
	98,  // 30: daemon.SystemEvent.metadata:type_name -> daemon.SystemEvent.MetadataEntry
	59,  // 31: daemon.GetEventsResponse.events:type_name -> daemon.SystemEvent
	99,  // 32: daemon.SetConfigRequest.dnsRouteInterval:type_name -> google.protobuf.Duration
	...
	95,  // 35: daemon.ExposeServiceEvent.ready:type_name -> daemon.ExposeServiceReady
	34,  // 36: daemon.Network.ResolvedIPsEntry.value:type_name -> daemon.IPList
	8,   // 37: daemon.DaemonService.Login:input_type -> daemon.LoginRequest
	10,  // 38: daemon.DaemonService.WaitSSOLogin:input_type -> daemon.WaitSSOLoginRequest
	12,  // 39: daemon.DaemonService.Up:input_type -> daemon.UpRequest
	14,  // 40: daemon.DaemonService.Status:input_type -> daemon.StatusRequest
	...
	79,  // 65: daemon.DaemonService.TriggerUpdate:input_type -> daemon.TriggerUpdateRequest
	81,  // 66: daemon.DaemonService.GetPeerSSHHostKey:input_type -> daemon.GetPeerSSHHostKeyRequest
	83,  // 67: daemon.DaemonService.RequestJWTAuth:input_type -> daemon.RequestJWTAuthRequest
	85,  // 68: daemon.DaemonService.WaitJWTToken:input_type -> daemon.WaitJWTTokenRequest
	87,  // 69: daemon.DaemonService.StartCPUProfile:input_type -> daemon.StartCPUProfileRequest
	89,  // 70: daemon.DaemonService.StopCPUProfile:input_type -> daemon.StopCPUProfileRequest
	6,   // 71: daemon.DaemonService.NotifyOSLifecycle:input_type -> daemon.OSLifecycleRequest
	91,  // 72: daemon.DaemonService.GetInstallerResult:input_type -> daemon.InstallerResultRequest
	93,  // 73: daemon.DaemonService.ExposeService:input_type -> daemon.ExposeServiceRequest
	...
	31,  // 80: daemon.DaemonService.ListNetworks:output_type -> daemon.ListNetworksResponse
	33,  // 81: daemon.DaemonService.SelectNetworks:output_type -> daemon.SelectNetworksResponse
	33,  // 82: daemon.DaemonService.DeselectNetworks:output_type -> daemon.SelectNetworksResponse
	38,  // 83: daemon.DaemonService.ForwardingRules:output_type -> daemon.ForwardingRulesResponse
	40,  // 84: daemon.DaemonService.DebugBundle:output_type -> daemon.DebugBundleResponse
	42,  // 85: daemon.DaemonService.GetLogLevel:output_type -> daemon.GetLogLevelResponse
	44,  // 86: daemon.DaemonService.SetLogLevel:output_type -> daemon.SetLogLevelResponse
	47,  // 87: daemon.DaemonService.ListStates:output_type -> daemon.ListStatesResponse
	49,  // 88: daemon.DaemonService.CleanState:output_type -> daemon.CleanStateResponse
	51,  // 89: daemon.DaemonService.DeleteState:output_type -> daemon.DeleteStateResponse
	53,  // 90: daemon.DaemonService.SetSyncResponsePersistence:output_type -> daemon.SetSyncResponsePersistenceResponse
	57,  // 91: daemon.DaemonService.TracePacket:output_type -> daemon.TracePacketResponse
	59,  // 92: daemon.DaemonService.SubscribeEvents:output_type -> daemon.SystemEvent
	61,  // 93: daemon.DaemonService.GetEvents:output_type -> daemon.GetEventsResponse
	63,  // 94: daemon.DaemonService.SwitchProfile:output_type -> daemon.SwitchProfileResponse
	65,  // 95: daemon.DaemonService.SetConfig:output_type -> daemon.SetConfigResponse
	67,  // 96: daemon.DaemonService.AddProfile:output_type -> daemon.AddProfileResponse
	69,  // 97: daemon.DaemonService.RemoveProfile:output_type -> daemon.RemoveProfileResponse
	71,  // 98: daemon.DaemonService.ListProfiles:output_type -> daemon.ListProfilesResponse
	74,  // 99: daemon.DaemonService.GetActiveProfile:output_type -> daemon.GetActiveProfileResponse
	76,  // 100: daemon.DaemonService.Logout:output_type -> daemon.LogoutResponse
	78,  // 101: daemon.DaemonService.GetFeatures:output_type -> daemon.GetFeaturesResponse
	80,  // 102: daemon.DaemonService.TriggerUpdate:output_type -> daemon.TriggerUpdateResponse
	82,  // 103: daemon.DaemonService.GetPeerSSHHostKey:output_type -> daemon.GetPeerSSHHostKeyResponse
	84,  // 104: daemon.DaemonService.RequestJWTAuth:output_type -> daemon.RequestJWTAuthResponse
	86,  // 105: daemon.DaemonService.WaitJWTToken:output_type -> daemon.WaitJWTTokenResponse
	88,  // 106: daemon.DaemonService.StartCPUProfile:output_type -> daemon.StartCPUProfileResponse
	90,  // 107: daemon.DaemonService.StopCPUProfile:output_type -> daemon.StopCPUProfileResponse
	7,   // 108: daemon.DaemonService.NotifyOSLifecycle:output_type -> daemon.OSLifecycleResponse
	92,  // 109: daemon.DaemonService.GetInstallerResult:output_type -> daemon.InstallerResultResponse
	94,  // 110: daemon.DaemonService.ExposeService:output_type -> daemon.ExposeServiceEvent
...
func file_daemon_proto_init() {
	...
	file_daemon_proto_msgTypes[70].OneofWrappers = []any{}
